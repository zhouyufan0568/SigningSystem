...
pageEncoding="utf-8"%>
    <%@ page import="java.io.*,java.util.*" %>
        ...
        <body>
            <table>
                <div id="loginattach" style="position: absolute; width: 428px; height: 296px; left: 739px; top: 148px; z-index: 10002;">
                    <div class="prompt">
                        <h1>用户登录</h1><span class="close"><img src="images/close.gif" onclick="do_close()"></span>
                        <h2><br>感谢使用管理员考勤系统，请登录：</h2>
                        ...
                        <h4><input type="button" name="login" value="登录" class="bottom" onclick="Login()"><input type="button" name="register" value="注册" class="bottom" onclick="Register()"></h4>
                    </div>
                </div>
            ...
            <script type="text/javascript">
                function Login() {
                    ...
                    jQuery.ajax({
                        url: "<%=request.getContextPath()%>/LoginServlet", //这里是传入的 servlet  
                        type: "post",
                        data: {
                            "id": id,
                            "password": password,
                ...
                function Register() {
                    // 重定向到新地址
                    window.location.href = "http://localhost:5716/SigningSystemServer/Register.jsp";
                }
            </script>
        </body>
